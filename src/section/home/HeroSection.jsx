            ...
            <Section banner={true} >
                <div className="grid grid-cols-12 gap-y-8 gap-[10px] grid-rows-1">
                    ...
                    <div className=' col-span-12 lg:col-span-9 grid grid-cols-12 gap-y-8 gap-x-[10px]'>
                        <div className="col-span-12 xl:col-span-5 h-fit  grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-1 lg:pr-[5px] gap-[10px]">
                        ...
                        <div className='col-span-12 xl:col-span-7 grid grid-cols-2 lg:px-[5px] gap-y-[16px] gap-x-[10px]'>
